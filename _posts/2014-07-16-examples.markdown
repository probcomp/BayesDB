...
Similarly, we can list the variables that share the most dependence with quality,
...
To check this result, we might look at some more generic assessment of spending such as the payment received per doctor's visit.
