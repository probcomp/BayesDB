...
Notice that quality and cost show no dependence.  We can list the variables that share the most dependence with spending, again focusing on Medicare spending on ambulances.
...
It appears that the other `_score` variables and quality score are dependent. Medicare expenditures, deaths, and days provide little evidence for dependence probability with the quality score.
