...
class Engine(object):
  ...
  def select(self, tablename, functions, whereclause, limit, order_by, impute_confidence=None, numsamples=None, plot=False, modelids=None, summarize=False, hist=False, freq=False, newtablename=None, infer=False, resolution=None):
    """
    ...
    for row_id, T_row in enumerate(T):
      ...
      where_clause_eval = select_utils.evaluate_where_on_row(row_id, row_values, where_conditions, M_c, M_c_full,
                               ...
                               T_full_imputed, T_full_imputed_confidences, cctypes_full, resolution)
