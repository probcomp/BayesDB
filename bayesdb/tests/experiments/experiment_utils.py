...
#    pylab.ylabel('')
    ...
    txt = '''
        ...
        %f trials, with %f percent of the target data missing. The dataset is %d rows by %d columns.

        Each imputation was calculated with %i samples from %i chains run for %i iterations.
    ''' % (num_trials, target_prop_missing[0], num_rows, num_cols, impute_samples, num_chains, num_iters)
